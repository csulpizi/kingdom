...
import { discoverExpansionCount, discoverKingdomCount, maxHandSize, } from "./consts.js";
    ...
    draw(n = 1) {
        ...
        if (this.deck.length > 0) {
            ...
            if (this.hand.length > maxHandSize) {
                log(coloredString("Your hand is full. Discarding the first card in your hand", "red"));
                this.hand[0].location = "graveyard";
            }
        }
